  ...
  storeUser() { 
    this.usersCollectionRef.add({
      ...
      render() {
        ...
        this.fireStoreData = firestore().collection("subject_Science").doc({text}.text).collection('Chat');
        this.usersCollectionRef = firestore().collection("subject_Science").doc({text}.text).collection('Chat');
