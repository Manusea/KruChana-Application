...
class Hw extends React.Component {
  ...
  render() {
    ...
    nameHw = {text}.text;
    // put data
    this.usersCollectionRef = firestore().collection("subject_Code").doc(nameHw).collection("ans");
    //show data
    this.fireStoreData = firestore().collection("subject_Code").doc(nameHw).collection("homeWorkDetail");
    /////////////////////////////////
