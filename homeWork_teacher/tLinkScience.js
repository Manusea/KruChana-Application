...
class test extends React.Component {
  constructor(props) {
    super(props);
    this.usersCollectionRef = firestore().collection('subject_Science').doc('Name').collection('hw')
    this.state = {
      name: '',
      time: 0
    };
        ...
        <ScrollView>
          ...
          style={styles.Image} />
            ...
            <TouchableOpacity style={styles.loginButton} onPress={() => {
                  this.props.navigation.navigate('nameHomeWorkScience', {text: this.state.name});
                  this.props.navigation.navigate('nameHomeWorkScience', {timer: this.state.time});
