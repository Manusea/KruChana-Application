        ...
        <ScrollView>
          <View style={styles.container}>
            <Image source={require("../img/math.png")} 
              ...
              onPress={() => this.props.navigation.navigate('tLinkMath')}
            />

            <Image source={require("../img/eng.png")} 
              style = {styles.picture}
              onPress={() => this.props.navigation.navigate('tLinkEng')}
            />

            <Image source={require("../img/sci.png")} 
              style = {styles.picture}
              onPress={() => this.props.navigation.navigate('tLinkScience')}
            />

            <Image source={require("../img/sw.png")} 
              style = {styles.picture}
              onPress={() => this.props.navigation.navigate('tLinkSoftware')}
            /> 

            <Image source={require("..//img/code.png")} 
              style = {styles.picture}
              onPress={() => this.props.navigation.navigate('tLinkcode')}
            />
