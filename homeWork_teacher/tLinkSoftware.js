...
class test extends React.Component {
  constructor(props) {
    super(props);
    this.usersCollectionRef = firestore().collection('subject_Software').doc('Name').collection('hw')
    this.state = {
      name: '',
      time: 0
    };
        ...
        <ScrollView>
          ...
          style={styles.Image} />
            ...
            <TouchableOpacity style={styles.loginButton} onPress={() => {
                  ...
                  this.props.navigation.navigate('nameHomeWorkSoftware', {timer: this.state.time});
